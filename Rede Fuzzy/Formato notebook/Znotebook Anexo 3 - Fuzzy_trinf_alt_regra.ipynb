...
#%% Importando os dados
csv_path = 'C:\\Users\\deivity.andrade\\OneDrive - Companhia de Gás de Santa Catarina - SCGÁS\\Área de Trabalho\\fuzzy\\Respira_DB_Tds.txt'
...
regra1 = ctrl.Rule(NIF['Fracasso'] & VT['Fracasso'] & RR['Fracasso'], desmame['Permanece'])
regra2 = ctrl.Rule(NIF['Fracasso'] & VT['Fracasso'] & RR['Sucesso'], desmame['Permanece'])
regra3 = ctrl.Rule(NIF['Fracasso'] & VT['Sucesso'] & RR['Fracasso'], desmame['Permanece'])
regra4 = ctrl.Rule(NIF['Sucesso'] & VT['Fracasso'] & RR['Fracasso'], desmame['Permanece'])
regra5 = ctrl.Rule(NIF['Sucesso'] & VT['Sucesso'] & RR['Sucesso'], desmame['Desmamar'])
regra6 = ctrl.Rule(NIF['Fracasso'] & VT['Sucesso'] & RR['Sucesso'], desmame['Permanece'])
regra7 = ctrl.Rule(NIF['Sucesso'] & VT['Sucesso'] & RR['Fracasso'], desmame['Permanece'])
regra8 = ctrl.Rule(NIF['Sucesso'] & VT['Fracasso'] & RR['Sucesso'], desmame['Permanece'])
...
for i in range(len(df)):
    teste_conjunto(df['NIF'].iloc[i], df['RR'].iloc[i], df['VT'].iloc[i])
