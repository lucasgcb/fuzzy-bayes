...
regra6 = ctrl.Rule(NIF['Fracasso'] & VT['Sucesso'] & RR['Sucesso'], desmame['Desmamar'])
regra7 = ctrl.Rule(NIF['Sucesso'] & VT['Sucesso'] & RR['Fracasso'], desmame['Desmamar'])
regra8 = ctrl.Rule(NIF['Sucesso'] & VT['Fracasso'] & RR['Sucesso'], desmame['Desmamar'])
