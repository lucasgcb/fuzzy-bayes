...
#%% Importando os dados
csv_path = 'C:\\Users\\deivity.andrade\\OneDrive - Companhia de Gás de Santa Catarina - SCGÁS\\Área de Trabalho\\fuzzy\\Respira_DB_Tds_RSBI_teste.txt'
...
regra12 = ctrl.Rule(NIF['Fracasso'] & VT['Sucesso'] & RR['Sucesso'] & RSBI['Sucesso'], desmame['Permanece'])
regra13 = ctrl.Rule(NIF['Sucesso'] & VT['Sucesso'] & RR['Fracasso'] & RSBI['Sucesso'], desmame['Permanece'])
regra14 = ctrl.Rule(NIF['Sucesso'] & VT['Fracasso'] & RR['Sucesso'] & RSBI['Sucesso'], desmame['Permanece'])
regra15 = ctrl.Rule(NIF['Sucesso'] & VT['Sucesso'] & RR['Sucesso'] & RSBI['Fracasso'], desmame['Permanece'])
